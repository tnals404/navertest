...
<body>
	...
	<button class="button" onclick="document.location.href='/changeVillage?town_id=${town_id}'" style="margin-top: 10px; padding: 5px 10px;">동네 변경하기</button>	
	</div>
	<div class="wrapper">
		<div class="firstBox">
			<div class="title">
...
$(document).ready(function() {
    ...
    let town_id = "&town_id=${town_id}"; // 동네 아이디
