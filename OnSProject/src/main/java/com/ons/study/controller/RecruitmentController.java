...
public class RecruitmentController {
	...
	public ModelAndView postviewedit(@RequestParam(value="id", required=false, defaultValue="1") int id, @RequestParam(value="groupid", required=false, defaultValue="1") int groupid) {
		RecruitmentDTO dto = service.recruitmentpostview(id);
		RecruitmentDTO dto2 = service.recruitmentpostview2(id);
		RecruitmentDTO dto3 = service.recruitmentpostview3(id);
		ModelAndView mv = new ModelAndView();
